...
<html>
    ...
    <body>
        ...
        <button type="button" class="pre">></button>
            ...
            <div class="help-benner"><p class="help-p">Can't Find What Do You Search?</p> Tidak tahu jenis obat yang kamu cari sesuai jenis keluhan penyakit ? <br>Atau kurang cocok dengan obat yang lama ?<br> Ingin mencari obat yang baru tapi tidak tahu tentang obat tersebut ?<br> Silahkan cari di halaman ini sesuai yang anda butuhkan</div>
        <img src="images/49.jpg" class="gambar1">
        <div class="keluhan2"><p class="k1">Search by of Kind</p>Cari Obat berdasarkan jenis dan kategorinya.<br> Jenis obat terdiri dari Kimia dan Herbal.<br> Kategori obat tardiri dari Umum dan Khusus</div>
            <select name="bulan" class="pos2">
<?php
$bulan=array('Pilih Jenis Obat','Kimia','herbal');
for($b=0;$b<=2;$b++)
{
echo "<option value='$b'>$bulan[$b]</option>";
}?>
</select>
            <select name="bulan" class="pos3">
<?php
$bulan=array('Pilih Kategori Obat','Umum','Khusus');
for($b=0;$b<=2;$b++)
{
echo "<option value='$b'>$bulan[$b]</option>";
}?>
</select>
            <button type="button" class="btn-hospital">Find Out</button>
            <div class="keluhan3"><p class="k1">Search by of Kind</p>Cari Obat berdasarkan jenis dan kategorinya.<br> Jenis obat terdiri dari Kimia dan Herbal.<br> Kategori obat tardiri dari Umum dan Khusus</div>
            <input type="text" class="nama8" placeholder="nama Penyakit">
            <input type="text" class="nama9" placeholder="Jenis Penyakit">
            <button type="button" class="btn-hospital2">Find Out</button>
            <div class="keluhan4"><p class="k1">Search by of Kind</p>Cari Obat berdasarkan jenis dan kategorinya.<br> Jenis obat terdiri dari Kimia dan Herbal.<br> Kategori obat tardiri dari Umum dan Khusus</div>
            <select name="bulan" class="pos4">
<?php
$bulan=array('Cara Pakai','Diminum','Di oles');
for($b=0;$b<=2;$b++)
{
echo "<option value='$b'>$bulan[$b]</option>";
}?>
</select>
            <select name="bulan" class="pos5">
<?php
$bulan=array('Tekstur Obat','Cair','Bubuk');
for($b=0;$b<=2;$b++)
{
echo "<option value='$b'>$bulan[$b]</option>";
}?>
</select>
            <button type="button" class="btn-hospital3">Find Out</button>
        </div>
