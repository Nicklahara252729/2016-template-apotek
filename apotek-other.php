...
<html>
        ...
        <style>
            *{
            ...
            .hospital{
                margin-top: 550px;
                width: 500px;
                box-shadow: 10px 10px 0px 0px #E2E2E4;
            }
            .btn-hospital{
                border: 0px;
                width: 400px;
    ...
    <body>
        ...
        <img src="images/apotek.png" class="logo">
            ...
            <a href="apotek-member.php"><button type="button" class="btn-member">Member</button></a>
            <a href="apotek-suplier.php"><button type="button" class="btn-suplier">Supplier</button></a>
        </header>
        ...
        <input type="text"  class="caritutor" placeholder="Cari Dokter">
            <button type="button" class="btn-caritutor">Cari</button>
            
            <div class="keluhan"><p class="k1">Free Consultation</p>Anda Memiliki Keluhan Tentang Kesehatan Anda ? <br>Silahkan Berkonsultasi dengan beberapa Dokter Terpercaya Berikut</div>
        <img src="images/38.jpg" class="gambar2">
        <img src="images/39.jpg" class="gambar3">
        <img src="images/40.jpg" class="gambar4">
        <img src="images/41.jpg" class="gambar5">
        <img src="images/44.jpg" class="gambar1">
            <div class="keluhan2"><p class="k1">Free Diagnose</p>Cari Tahu Jenis Penyakit Yang Anda Derita <br>Dengan Mengisi Identitas dan<br> Pertanyaan Umum Yang ada disamping Seputar Keluhan Anda</div>
            <input type="text" class="nama1" placeholder="Nama Lengkap">
            <input type="text" class="nama2" placeholder="Email">
            <input type="text" class="nama3" placeholder="Usia">
            <input type="text" class="nama4" placeholder="Bagian tubuh mana yang bermasalah">
            <input type="text" class="nama5" placeholder="Gejala Awal">
            <input type="text" class="nama6" placeholder="Keluhan yang dirasakan sekarang">
            <input type="text" class="nama7" placeholder="Sudah Berapa Lama ?">
            <input type="text" class="nama8" placeholder="Jenis makanan apa yg sering anda makan ?">
            <button type="button" class="reset2">Reset</button>
            <button type="button" class="kirim2">Submit</button>
        <img src="images/48.jpg" class="hospital">
            <div class="keluhan3"><p class="k1">Find Out Hospital</p>Cari Tahu Tentang Berbagai Macam Rumah Sakit<br>Mulai dari Lokasi, Kualitas, Kuantitas, Harga, dan Pelayanan yang disediakan</div>
            <button type="button" class="btn-hospital">More Information</button>
            </div>
