...
<html>
    <meta charset="utf-8">
    <head>
        <title>Apotek.Com - Inventory</title>
        <style>
            *{
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <input type="text"  class="caritutor" placeholder="Cari Obat">
            <button type="button" class="btn-caritutor">Cari</button>
            
            <div class="keluhan"><p class="k1">Your Inventory</p>Perikasa Inventory Anda Apakah Stok Obat dari Anda Sudah Habis atau Belum<br>Pastikan Anda melihat dengan  jeli, karena apabila ada kelahan dari anda kami tidak akan bertanggung jawab</div>
        <img src="images/51.jpg" class="gambar2">
        <img src="images/52.jpg" class="gambar3">
        <img src="images/53.jpg" class="gambar4">
        <img src="images/54.jpg" class="gambar5">
        <img src="images/50.jpg" class="gambar1">
            <div class="keluhan2"><p class="k1">Supplay Obat ke Apotek.com</p>Tugas Pemodelan Perangkat Lunak rancangan User Interface Sistem Penjualan Obat</div>
        
            <div class="keluhan3"><p class="k1">Ambil Obat yang Sudah Kadaluarsa</p>Tugas Pemodelan Perangkat Lunak rancangan User Interface Sistem Penjualan Obat</div>
            <div class="keluhan4"><p class="k1">Lihat Stok Obat</p>Tugas Pemodelan Perangkat Lunak rancangan User Interface Sistem Penjualan Obat</div>
            </div>
