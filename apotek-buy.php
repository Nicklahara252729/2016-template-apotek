...
<html>
    <meta charset="utf-8">
    <head>
        <title>Apotek.Com - Buy Form</title>
        <style>
            *{
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <form>
        <input type="text" class="nama" placeholder="Nama lengkap" required>
        <input type="text" class="email" placeholder="Email" required>
        <input type="text" class="alamat" placeholder="Alamat Pengiriman" required>
        <p class="kelahiran">Tanggal Lahir</p>    <select name="tgl" class="tgl">
<?php
for($t=1;$t<=31;$t++)
{
...
echo "<option value='$b'>$bulan[$b]</option>";
        ...
        <input type="checkbox" class="cek"><p class="nama-obat"> Laki - Laki</p>
        <input type="checkbox" class="cek2"><p class="nama-obat2"> Perempuan</p>
            <input type="text" class="alamat2" placeholder="No Telepon" required>
...
<?php
$bulan=array('Pilih Pembayaran','Rekening','Master Card','Visa','Paypal','Bitcoin');
for($b=0;$b<=5;$b++)
{
echo "<option value='$b'>$bulan[$b]</option>";
}?>
            ...
            <input type="text" class="nama" placeholder="Total Harga" required>
        <button type="reset" class="btn-isi1-2">Reset</button>
        <a href="apotek-verify.php"><button type="button" class="btn-isi1">Submit</button></a>
            </form>
        </div>
