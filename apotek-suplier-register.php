...
<html>
    <meta charset="utf-8">
    <head>
        <title>Apotek.Com - Supplier Register</title>
        <style>
            *{
                margin: 0;
                padding: 0;
    ...
    <body>
        ...
        <p class="judulc1">Registrasi Supplier</p>
        <form>
        ...
        <input type="text" class="email" placeholder="Alamat" required>
...
echo "<option value='$b'>$b</option>";
        ...
        <input type="checkbox" class="cek2"><p class="nama-obat2"> Perempuan</p>
            <input type="text" class="email" placeholder="kota Asal" required>
